      ...
      >
        ...
        {isMobile ? (
          ...
          <div style={{ background: 'var(--surface)', borderBottom: `3px solid ${accent}`, padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 12, position: 'sticky', top: 0, zIndex: 10, flexShrink: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div style={{ fontSize: 11, color: 'var(--text2)', fontFamily: 'DM Mono, monospace', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
        ...
        <div style={isMobile
          ...
          <div style={{ textAlign: 'center', paddingBottom: 20, borderBottom: '1px solid rgba(255,255,255,0.07)', display: isMobile ? 'none' : 'block' }}>
            ...
            <div style={{ fontFamily: 'DM Mono', fontSize: 10, color: 'var(--text2)', marginTop: 3 }}>Paramount · Encore · Ameraycan · Wilder · Track · Enterprise</div>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 8 }}>
              <span style={{ fontFamily: 'DM Mono', fontSize: 10, color: 'var(--text2)' }}>Recording Studios (323) 465-4000</span>
              <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                <span style={{ fontFamily: 'DM Mono', fontSize: 10, color: 'var(--text2)' }}>Invoice #</span>
                ...
                <div style={{ display: 'flex', gap: 12 }}>
                  {['COD', 'Billing'].map(p => (
                    <label key={p} style={{ display: 'flex', alignItems: 'center', gap: 5, cursor: 'pointer' }}>
                      ...
                      <span style={{ fontFamily: 'DM Mono', fontSize: 11, color: wo.payment_status === p ? '#f0f0f0' : 'var(--text2)' }}>{p}</span>
                    </label>
                  ))}
                </div>
              </div>
            ...
            <div style={{ border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, overflowX: isMobile ? 'auto' : 'hidden', overflowY: 'hidden', WebkitOverflowScrolling: 'touch' }}>
                        ...
                        <div style={{ ...cellS, justifyContent: 'center', padding: '3px 2px', pointerEvents: 'auto' }}>
                          {!readOnly && (confirmDeleteRowId === r.id ? (
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                              <span style={{ fontSize: 7, color: 'var(--warm)', fontFamily: 'DM Mono', whiteSpace: 'nowrap' }}>Del?</span>
                              <div style={{ display: 'flex', gap: 3 }}>
                                <button type="button" onClick={() => deleteStRow(r.id)} style={{ fontSize: 8, fontFamily: 'DM Mono', color: 'var(--warm)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, fontWeight: 700 }}>Y</button>
                                <button type="button" onClick={() => setConfirmDeleteRowId(null)} style={{ fontSize: 8, fontFamily: 'DM Mono', color: 'var(--text2)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>N</button>
                              </div>
                            </div>
                          ) : (
                            <button type="button" onClick={() => setConfirmDeleteRowId(r.id)} style={{ fontSize: 13, fontFamily: 'DM Mono', color: 'var(--text3)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, lineHeight: 1 }}>×</button>
                          ))}
                        </div>
                      </div>}
                      {!isEngOnly && pendingLockedEdits[r.id] && (
                        <div style={{ padding: '5px 12px', background: 'rgba(20,184,166,0.08)', borderBottom: '1px solid rgba(20,184,166,0.2)', display: 'flex', alignItems: 'center', gap: 8, fontSize: 10, fontFamily: 'DM Mono', color: 'var(--booked)' }}>
                          ...
                          <button
                            ...
                            style={{ padding: '2px 8px', borderRadius: 3, border: '1px solid var(--booked)', background: 'rgba(20,184,166,0.15)', color: 'var(--booked)', fontSize: 9, fontFamily: 'DM Mono', fontWeight: 700, cursor: 'pointer' }}
                          >Update</button>
                          <button
                            type="button"
                            ...
                            style={{ padding: '2px 8px', borderRadius: 3, border: '1px solid rgba(255,255,255,0.12)', background: 'transparent', color: 'var(--text2)', fontSize: 9, fontFamily: 'DM Mono', cursor: 'pointer' }}
                          >Revert</button>
                        </div>
                      )}
                      {(r.studio === '' || !!wo?.engineer || !!r.eng_rate) && r.eng_visible !== false && (
                        <>
                          <div style={{ display: 'grid', gridTemplateColumns: '70px 65px 1fr 66px 66px 40px 52px 76px 50px 70px 68px 76px 40px 24px', borderBottom: '1px solid rgba(255,255,255,0.04)', background: 'rgba(200,240,78,0.03)' }}>
                            ...
                            {/* Eng delete × */}
                            <div style={{ ...cellS, justifyContent: 'center', padding: '3px 2px', pointerEvents: 'auto' }}>
                              {!readOnly && <button type="button" onClick={() => setConfirmClearEngId(r.id)} style={{ fontSize: 13, fontFamily: 'DM Mono', color: 'var(--text3)', background: 'none', border: 'none', cursor: 'pointer', padding: 0, lineHeight: 1 }}>×</button>}
                            </div>
                          </div>
                          {confirmClearEngId === r.id && (
                            <div style={{ padding: '5px 12px', background: 'rgba(249,115,22,0.08)', borderBottom: '1px solid rgba(249,115,22,0.2)', display: 'flex', alignItems: 'center', gap: 8, fontSize: 10, fontFamily: 'DM Mono', color: 'var(--warm)' }}>
                              <span>Delete engineer row?</span>
                              <button type="button" onClick={() => isEngOnly ? deleteStRow(r.id) : clearEngRow(r.id)} style={{ padding: '2px 8px', borderRadius: 3, border: '1px solid var(--warm)', background: 'rgba(249,115,22,0.15)', color: 'var(--warm)', fontSize: 9, fontFamily: 'DM Mono', fontWeight: 700, cursor: 'pointer' }}>Y</button>
                              <button type="button" onClick={() => setConfirmClearEngId(null)} style={{ padding: '2px 8px', borderRadius: 3, border: '1px solid rgba(255,255,255,0.12)', background: 'transparent', color: 'var(--text2)', fontSize: 9, fontFamily: 'DM Mono', cursor: 'pointer' }}>N</button>
                            </div>
                          )}
                        </>
                      )}
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '7px 10px', background: 'var(--surface2)', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <div style={{ display: 'flex', gap: 14, alignItems: 'center' }}>
                  <button type="button" onClick={addStRow} style={{ fontSize: 10, fontFamily: 'DM Mono', color: 'var(--text2)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>+ Add Studio Time</button>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 3 }}>
                  ...
                  {engTotal > 0 && (
                    <span style={{ fontSize: 11, fontFamily: 'DM Mono', color: 'var(--accent)' }}>Eng: ${engTotal.toFixed(2)}</span>
                  )}
                  {engTotal > 0 && (
          ...
          <div style={isMobile ? mCard : undefined}>
            ...
            <div style={{ border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, overflowX: isMobile ? 'auto' : 'hidden', overflowY: 'hidden', WebkitOverflowScrolling: 'touch' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '7px 10px', background: 'var(--surface2)', borderTop: '1px solid rgba(255,255,255,0.06)', minWidth: isMobile ? 540 : undefined }}>
                {!readOnly ? <button type="button" onClick={() => setRentRows(p => [...p, { id: crypto.randomUUID(), qty: '', item: '', supplier: '', dates_used: '', rate: '', charge: '' }])} style={{ fontSize: 10, fontFamily: 'DM Mono', color: 'var(--text2)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>+ Add row</button> : <span />}
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16, ...(isMobile ? mCard : {}) }}>
              <div>
                ...
                <textarea value={wo.session_notes} onChange={e => setWo(w => w ? { ...w, session_notes: e.target.value } : w)}
                  style={{ width: '100%', minHeight: 90, background: 'var(--surface2)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: 5, color: '#f0f0f0', fontFamily: 'DM Mono', fontSize: 11, padding: '8px 10px', outline: 'none', resize: 'vertical', lineHeight: 1.6, boxSizing: 'border-box' }} />
              </div>
              {wo.payment_status === 'COD' && (
                <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                  <div style={{ fontSize: 9, fontFamily: 'DM Mono', color: 'var(--text3)', lineHeight: 1.8, padding: '10px 12px', background: 'var(--surface2)', borderRadius: 5, border: '1px solid rgba(255,255,255,0.05)' }}>
                  ...
                  <div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 }}>
                      ...
                      {!readOnly && <button type="button" onClick={clearAdminSignature} style={{ background: 'none', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 4, padding: '2px 8px', color: 'var(--text2)', fontSize: 10, cursor: 'pointer', fontFamily: 'DM Mono' }}>Clear</button>}
                    </div>
                    {!readOnly && (
                    <canvas
                      ref={adminCanvasRef}
                    ...
                    {wo.signature_data && <div style={{ fontSize: 9, color: 'var(--text3)', fontFamily: 'DM Mono', marginTop: 4 }}>Signature captured ✓</div>}
                  </div>
                </div>
              )}
            </div>
              ...
              <div>
                ...
                <div style={{ border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '7px 10px' }}>
                    {!readOnly && <button type="button" onClick={() => setPayRows(p => [...p, { id: crypto.randomUUID(), payment_type: '', amount: '', memo: '', last_four: '' }])} style={{ fontSize: 10, fontFamily: 'DM Mono', color: 'var(--text2)', background: 'none', border: 'none', cursor: 'pointer', padding: 0 }}>+ Add payment</button>}
                  </div>
                </div>
              </div>
              {/* Totals block */}
              <div style={{ border: '1px solid rgba(255,255,255,0.07)', borderRadius: 6, overflow: 'hidden' }}>
                {[
                  ...
                  <div key={label} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
                    <span style={{ fontSize: 10, fontFamily: 'DM Mono', color: 'var(--text2)' }}>{label}</span>
          ...
          <div data-no-print="" style={isMobile ? mCardOrange : { borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: 20 }}>
            ...
            <textarea
              ...
              style={{ width: '100%', minHeight: 80, background: 'var(--surface2)', border: '1px solid rgba(249,115,22,0.3)', borderRadius: 5, color: '#f0f0f0', fontFamily: 'DM Mono', fontSize: 11, padding: '8px 10px', outline: 'none', resize: 'vertical', lineHeight: 1.6, boxSizing: 'border-box' }}
            />
