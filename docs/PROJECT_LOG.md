...
- **Still open:** Eli also said the studio-time table is "hard to read" generally. The column swap addresses part of it; a broader readability pass on that table is NOT done and needs its own scope.
