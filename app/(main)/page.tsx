                  ...
                  >
                    ...
                    <div style={{ flex: 1, minHeight: 0 }}>
                      <SessionCardBody
                        ...
                        isMobile={isMobile}
                        // Text-only legibility bump (Eli, 2026-08-26: "just make
                        // the info inside each square bigger, like the text").
                        // `large` was tried first and rejected — it grew the
                        // cards and broke the grid. boostText changes FONT SIZES
                        // ONLY; card geometry identical.
                        boostText={isMobile}
                      />
                    </div>
                  </div>
