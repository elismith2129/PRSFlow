...
export default function DailyOpsLogPage() {
  ...
  return (
    <div style={{ padding: '28px 32px', maxWidth: 1200 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <div style={{ fontFamily: 'Syne', fontWeight: 900, fontSize: 22, color: 'var(--text)', marginBottom: 4 }}>Daily Ops Log</div>
        ...
        {loading ? (
          ...
          filtered.map((r, i) => {
            ...
            return (
              ...
              >
                {/* Date */}
                <span style={{ fontSize: 11, color: 'var(--text2)', fontFamily: 'DM Mono, monospace', alignSelf: 'center' }}>
                  {r.date || '—'}
                </span>
                ...
                <div style={{ alignSelf: 'center' }}>
                  <span style={{
                    ...
                    color: isWO ? '#c8f04e' : 'var(--text2)',
                    background: isWO ? '#c8f04e22' : 'var(--surface2)',
                  }}>
                    {r.typeLabel}
                  </span>
                </div>
                ...
                <div style={{ alignSelf: 'center', overflow: 'hidden' }}>
                  {r.clientName && (
                    <div style={{ fontSize: 12, color: 'var(--text)', fontFamily: 'Syne', fontWeight: 600, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                      {r.clientName}
                    </div>
                  )}
                  {r.runnerName && (
                ...
                <div style={{ alignSelf: 'center' }}>
                  <div style={{ fontSize: 10, color: '#4ade80', fontFamily: 'DM Mono, monospace' }}>
                    ✓ {r.approvedAt ? fmtTime(r.approvedAt) : 'Approved'}
                  </div>
                  {r.approvedAt && (
                    <div style={{ fontSize: 9, color: 'var(--text3)', fontFamily: 'DM Mono, monospace', marginTop: 1 }}>
                ...
                {/* Approved by */}
                <span style={{ fontSize: 10, color: 'var(--text3)', fontFamily: 'DM Mono, monospace', alignSelf: 'center' }}>
                  {r.approvedBy ?? '—'}
                </span>
